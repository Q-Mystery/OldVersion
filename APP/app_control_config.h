...
#define LINE_CURVE_SLOW_SPEED_MM_S         (60)
#define LINE_CURVE_SLOW_HOLD_MS            (500U)
#define LINE_CURVE_SLOW_GYRO_RATE_X10      (150)  /* 15.0 deg/s */
#define LINE_CURVE_SLOW_MAX_TURN_DELTA_MM_S (35)
#define LINE_CURVE_SLOW_SOFT_INNER_SPEED_MM_S (25)
#define LINE_CURVE_SLOW_SOFT_OUTER_SPEED_MM_S (70)
#define LINE_CURVE_SLOW_MEDIUM_INNER_SPEED_MM_S (0)
#define LINE_CURVE_SLOW_MEDIUM_OUTER_SPEED_MM_S (65)
#define LINE_CURVE_SLOW_HARD_INNER_SPEED_MM_S (0)
#define LINE_CURVE_SLOW_HARD_OUTER_SPEED_MM_S (60)
