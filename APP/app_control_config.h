...
#define LINE_FAST_STABLE_MS                (50U)
#define LINE_FAST_RAMP_STEP_MM_S           (25)
#define LINE_FAST_RAMP_STEP_MS             (40U)
#define LINE_TURN_LATCH_MS                 (100U)
#define LINE_LOST_BRAKE_MS                 (60U)
#define LINE_LOST_RECOVERY_MS              (560U)
#define LINE_FAST_AFTER_TURN_STABLE_MS     (200U)
#define LINE_CURVE_APPROACH_SPEED_MM_S     (115)
#define LINE_CURVE_EXIT_LOCKOUT_MS         (250U)
#define LINE_GYRO_APPROACH_RATE_X10        (150)  /* 15.0 deg/s */
#define LINE_SOFT_TURN_INNER_SPEED_MM_S    (25)
#define LINE_SOFT_TURN_OUTER_SPEED_MM_S    (115)
